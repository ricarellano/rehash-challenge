    ...
    <>
      ...
      <div className={styles.heroImg}>
        <div className={styles.heroText}>
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. At quis in
            viverra feugiat dolor malesuada netus faucibus. Egestas magna massa
            tellus.
          </p>
        </div>
      </div>
      <div className={styles.info}>
        <div className={styles.title}>
          ...
          <p>
            ...
            erat imperdiet nulla quam nunc.{" "}
          </p>
        </div>
